...
class LocksmithPage extends StatelessWidget {
  final List<Map<String, dynamic>> locksmiths = [
    {
      "name": "James Lock",
      "experience": "10 years",
      "rating": 4.9,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Locksmiths", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22)),
            ...
            return GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => PartnerDetailPage(partner: locksmiths[index]),
                  ),
                );
              },
              child: _buildLocksmithCard(locksmiths[index]),
            );
          },
        ),
      ),
  ...
  Widget _buildLocksmithCard(Map<String, dynamic> worker) {
    return Container(
